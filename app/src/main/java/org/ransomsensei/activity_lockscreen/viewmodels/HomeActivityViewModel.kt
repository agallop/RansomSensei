...
class HomeActivityViewModel(private val repository: RansomSenseiDataRepository,
                            _ioDispatcher: CoroutineDispatcher = Dispatchers.IO) : ViewModel() {
    var isLoading by mutableStateOf(true)
    var isInOnboarding by mutableStateOf(false)

    init {
        viewModelScope.launch(_ioDispatcher) {
